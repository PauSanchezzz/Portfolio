      ...
      technologies: [
        {
          ...
          imgTechnology: '/svg/excel.svg',
          title: 'Excel',
        },
        {
          background: 'bg-yellow-600',
          colorHover: 'hover:drop-shadow-yellow',
          imgTechnology: '/svg/powerBi.svg',
          title: 'Power BI',
        },
        {
          background: 'bg-[#134D88]',
          colorHover: 'hover:drop-shadow-tecnology-blue',
          imgTechnology: '/svg/bd.svg',
          title: 'DAX',
        },
      ],
    },
    {
      ...
      technologies: [
        ...
        },
        {
          ...
          imgTechnology: '/svg/html.svg',
          title: 'HTML',
        },
        {
          background: 'bg-tecnology-blue',
          colorHover: 'hover:drop-shadow-tecnology-blue',
          imgTechnology: '/svg/css.svg',
          title: 'CSS',
        },
      ],
    },
      ...
      technologies: [
        {
          background: 'bg-background',
          colorHover: 'hover:drop-shadow-purple',
          imgTechnology: '/svg/kotlin.svg',
          title: 'Kotlin',
        },
        {
          background: 'bg-yellow-600',
          colorHover: 'hover:drop-shadow-yellow',
          imgTechnology: '/svg/firebase.svg',
          title: 'Firebase',
        },
        {
          background: 'bg-orange-700',
          colorHover: 'hover:drop-shadow-orange',
          imgTechnology: '/svg/figma.svg',
          title: 'Figma',
        },
        {
          background: 'bg-[#4CAB7B]',
          colorHover: 'hover:drop-shadow-darkgreen',
          imgTechnology: '/svg/jetpackCompose.svg',
